...
<body style="margin: 0; padding: 40px 20px; background-color: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 500px; margin: 0 auto; background: white; border-radius: 16px; padding: 40px;">
    ...
    <div style="text-align: center; margin-bottom: 32px;">
      <h1 style="margin: 0; color: #0f172a; font-size: 28px; font-weight: 700; letter-spacing: -0.025em;">New Crew Member Request</h1>
      <p style="margin: 12px 0 0 0; color: #475569; font-size: 16px; line-height: 1.5;">A new visitor has submitted their application and awaits your review, ${adminName}.</p>
    </div>

    <!-- Applicant Details -->
    <div style="margin: 32px 0; padding: 24px; background: linear-gradient(135deg, #fef3c7, #fde68a); border-radius: 12px; border-left: 4px solid #f59e0b;">
      <h3 style="margin: 0 0 16px 0; color: #0f172a; font-size: 18px; font-weight: 600;">Applicant Information:</h3>
      <div style="color: #374151; font-size: 15px; line-height: 1.6;">
        <p style="margin: 0 0 8px 0;"><strong>Name:</strong> ${applicantName}</p>
        <p style="margin: 0 0 8px 0;"><strong>Email:</strong> ${applicantEmail}</p>
        <p style="margin: 0;"><strong>Status:</strong> <span style="color: #f59e0b; font-weight: 600;">Pending Review</span></p>
      </div>
    </div>

    <!-- Review Button -->
    <div style="text-align: center; margin: 36px 0;">
      <a href="${reviewUrl}" style="display: inline-block; background: linear-gradient(135deg, #0ea5e9, #0284c7); color: white; text-decoration: none; padding: 16px 32px; border-radius: 10px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 14px 0 rgba(14, 165, 233, 0.3); transition: all 0.2s; border: none;">
        Review Application
      </a>
    </div>
    ...
    <div style="margin: 32px 0; padding: 20px; background: linear-gradient(135deg, #f0f9ff, #e0f2fe); border-radius: 12px; border-left: 4px solid #0ea5e9;">
      ...
      <ul style="margin: 0; padding-left: 20px; color: #475569; font-size: 14px; line-height: 1.6;">
        <li>Review the applicant's business profile</li>
        <li>Verify their referral network alignment</li>
        <li>Approve or provide feedback for improvements</li>
      </ul>
    </div>
