const swabbieInitialReviewTemplate = (fullPortUrl: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Your Coastal Referral Exchange Application - Under Review</title>
</head>
<body style="margin: 0; padding: 20px 10px; background-color: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 500px; margin: 0 auto; background: white; border-radius: 16px; padding: 20px;">
    ...
    <div style="text-align: center; margin-bottom: 32px;">
      <h1 style="margin: 0; color: #0f172a; font-size: 28px; font-weight: 700; letter-spacing: -0.025em;">Anchored at port – initial review completed</h1>
      <p style="margin: 12px 0 0 0; color: #475569; font-size: 16px; line-height: 1.5;">
        The Quartermaster has completed the initial review of your application. Your voyage now continues into the background check stage — a standard step before joining the Coastal Referral Exchange muster.
      </p>
    ...
    <div style="margin: 32px 0; padding: 20px; background: linear-gradient(135deg, #eff6ff, #dbeafe); border-radius: 12px; border-left: 4px solid #3b82f6;">
      ...
      <div style="margin-bottom: 12px;">
        ...
        <div style="display: flex; align-items: center; margin-bottom: 8px;">
          ...
          <span style="color: #3b82f6; font-size: 14px; font-weight: 600;">Background Check (Current Step)</span>
        </div>
    ...
    <div style="margin: 32px 0; padding: 20px; background: #f0f9ff; border-radius: 12px; border-left: 4px solid #0ea5e9;">
      ...
      <ul style="margin: 0; padding-left: 20px; color: #475569; font-size: 14px; line-height: 1.6;">
        <li>Reviewing your business credentials and license status</li>
        <li>Validating your contact and company details for accuracy</li>
        <li>Conducting standard compliance and background checks</li>
      </ul>
    </div>

    <!-- Timeline Section -->
    <div style="margin: 32px 0; padding: 20px; background: #fefce8; border-radius: 12px; border-left: 4px solid #eab308;">
      <h3 style="margin: 0 0 12px 0; color: #0f172a; font-size: 16px; font-weight: 600;">Expected Timeline:</h3>
      <p style="margin: 0; color: #475569; font-size: 14px; line-height: 1.6;">
        Background checks typically take 1-3 business days to complete. We'll notify you immediately once this phase is finished and we've made our final decision'.
      </p>
    </div>
...
export default swabbieInitialReviewTemplate
